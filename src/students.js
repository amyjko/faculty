	...
	render() {
		...
		return (
			<div>
				...
				<ul>
					<li><strong>Are you a prospective Ph.D. student?</strong> Apply to the <a href="http://ischool.uw.edu/phd" target="_blank">iSchool</a> or <a href="http://www.cs.washington.edu/education/grad/prospective.html" target="_blank">CSE</a>, but note that I have much more control over iSchool admissions. Write me an email, share your interests, and ask if I'm taking new students. Reach out to my current students and ask about their experiences.</li>
					<li><strong>Are you a current Ph.D. student at UW interested in working with me?</strong> Lurk on the <i>#codeandcognition</i> channel on <a target="_blank" href="https://uwdub.slack.com">DUB's Slack</a>. Write me an email and let's chat.</li>
					<li><strong>Are you a UW undergrad interested in in research?</strong>I only have a small capacity for undergraduate researchers in my lab, but it never hurts to ask if I'm available. Additionally, at the beginning of each Winter quarter, I put up an application process for full-time undergraduate summer research positions, where you can work closely with me and my doctoral students.</li>
				</ul>
