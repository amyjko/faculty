	...
	render() {
		return (
			<div>
				...
				<p>Andrew J. Ko is an Associate Professor at the <a href="http://www.washington.edu">University of Washington</a> <a href="http://ischool.uw.edu/">Information School</a> and an Adjunct Associate Professor in <a href="http://cs.washington.edu">Computer Science and Engineering</a>. He directs the Code &amp; Cognition Lab, where he invents and evaluates interactions between people and code, spanning the areas of human-computer interaction, computing education, and software engineering. He is the author of over 100 peer-reviewed publications, 9 receiving best paper awards and 3 receiving most influential paper awards. In 2013, he co-founded <a href="http://www.answerdash.com">AnswerDash</a>, a SaaS company offering instant answers on websites using a selection-based search technology invented in his lab. In 2010, he was awarded an NSF CAREER award for research on evidence-based bug triage. He received his Ph.D. at the <a href="http://www.hcii.cs.cmu.edu">Human-Computer Interaction Institute</a> at <a href="http://www.cmu.edu">Carnegie Mellon University</a> in 2008. He received degrees in Computer Science and Psychology with Honors from <a href="http://www.oregonstate.edu">Oregon State University</a> in 2002.</p>
