...
<p>
	...
	<External to="http://cs.washington.edu">The Paul G. Allen School of Computer Science & Engineering</External>, 
	the <External to="https://education.uw.edu">College of Education</External>, and occasionally other units on campus.
...
<ul>
	<li>Our weekly lab meetings are open to any doctoral students or postdocs at UW.</li>
	<li>Read our <Link to={"/lablets"}>lablets</Link> page for details on how we engage undergraduates in research.</li>
	<li>Read our <External to="https://docs.google.com/document/d/1LMHv0HdxXEgSNqICt3wtq8xWuH73kP7plZ_KeXyP6qM/edit?usp=sharing">onboarding document</External> for context on ever-evolving culture of the lab.</li>
	<li>
		Subscribe to our lab calendar (add <strong>codeandcognition@uw.edu</strong> if using UW G Suite, 
		download this <External to="https://calendar.google.com/calendar/ical/codeandcognition%40uw.edu/public/basic.ics">ICS file</External> otherwise) to see when lab meetings, 
		lablet meetings, and other activities are scheduled.
	</li>
</ul>

<p>
	I work hard to be a better mentor and advisor every year.
	In fact, in 2021, my students nominated me for the <External to="https://grad.uw.edu/for-faculty-and-staff/list-of-recipients/">Marsha L. Landolt Distinguished Graduate Mentor Award</External>, and I won one of two honorable mentions.
...
{#each $profile.getPeople(
	...
	person => { return { "undergrad": 5, "masters": 4, "phd": 3, "postdoc": 2, "faculty": 1, "director": 0 }[person.level] * 10000 + person.startdate }
) as person }
	<Person person={person} highlight={isPersonHighlighted(person.id)} />
{/each}
