...
<p>
	You can read more about my view of information and computing in a blog post I wrote about <External to="https://medium.com/bits-and-behavior/big-ideas-about-information-c09e4d9c60bd">big ideas about information</External>.
</p>
</Section>
...
<p>
	Shriram Krishnamurthi has a wonderful guide on <External to="https://parentheticallyspeaking.org/articles/us-cs-phd-faq/">Getting a Computer Science PhD</External>. 
...
<p>
	There are many resources on this. <External to="http://matt.might.net/articles/successful-phd-students/">Matt Might's advice</External> has a sobering but practical look, including a <External to="https://matt.might.net/articles/phd-school-in-pictures/">fun visual metaphor</External>> of what it means to do a PhD.
	I also like <External to="https://freedom-to-tinker.com/2010/09/27/advice-new-graduate-students/">Jennifer Rexford's view of Ph.D. life as individual growth by leveraging the group</External>, because it complements more pragmatic views.
	The Economist also has some practical advice on <External to="http://www.economist.com/node/17723223?fsrc=scn/fb/wl/ar/mr/disposableacademic">Why doing a PhD is often a waste of time</External>. 
	And, for a lighter glimpse into Ph.D. life, there is always <External to="http://www.phdcomics.com/comics.php">Ph.D. comics</External>.
</p>
</Section>
...
<Section id="goodquestion" header="What makes a good research paper?">	
	<p>
		...
		I wrote a book chapter that <Link to={"/papers/Ko2019StudyDesign.pdf"}>covers many aspects of developing good research questions</Link>. 
...
<Section id="goodwriting" header="How can I become a good technical writer?">
	...
	<ul>
		<li>Matt Might's <External to="http://matt.might.net/articles/shell-scripts-for-passive-voice-weasel-words-duplicates/">advice on technical writing</External> is a helpful guide</li>
		<li>I like Niklas Elmqvist's deconstruction of <External to="https://sites.umiacs.umd.edu/elm/2016/11/19/writing-rebuttals/">what makes a good rebuttal to conference reviews</External>.</li>
		<li>Chris Parnin's <External to="https://medium.com/@gameweld/error-codes-for-paper-introductions-8deb0d6825c2?fbclid=IwAR0SziEHps-ZD24FqLzG-yAGbk0wMblZ8dmC3r8KwsRsYdthVC6R0ylvWSg">Error Codes for Paper Introductions</External> is a fun and helpful guide.</li>
		<li>Morgan Klause Scheuerman has an excellent guide on <External to="https://www.morgan-klaus.com/gender-guidelines.html">reporting gender</External>.</li>
	</ul>
</Section>
...
<p>
	...
	I could write a whole book on this (and <External to="http://www.amazon.com/Research-Methods-Statistics-Psychology-Coolican/dp/0340812583">several</External> 
	<External to="http://www.amazon.com/Research-Methods-Psychology-John-Shaughnessy/dp/007128351X/ref=sr_1_1?s=books&ie=UTF8&qid=1281625862&sr=1-1">people</External> 
	<External to="http://www.socialresearchmethods.net/">have</External>, just not on the topic of CS research).
</p>
...
{#if guide }<Paper paper={guide} />{:else}Hm, couldn't find the guide, sorry!{/if}

<hr/>

<p>
	Several of my colleagues in software engineering and programming languages also wrote a well reasoned analysis of <em>claims</em> in evaluations called <External to="http://dl.acm.org/citation.cfm?id=2983574">The Truth, The Whole Truth, and Nothing But the Truth: A Pragmatic Guide to Assessing Empirical Evaluations</External>. 
...
<p>
	Casey Fiesler has <External to="http://caseyfiesler.com/2014/10/02/acm-publication-copyright/">a helpful blog post</External> about this decision.
