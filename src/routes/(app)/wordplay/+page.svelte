...
<p
    >I'm recruiting volunteers to contribute to <External
...
<p>
    ...
    >. Contributing means helping with the open source research project and
...
<ol>
    <li
        ...
        to attend meetups at the <Link to="/wordplay/#meetups"
    ...
    <li
        ><strong>Apply</strong>. Next, fill out the <Link
            to="https://forms.gle/8iKs2CqAWzxNYVcG8">Wordplay application</Link
    ...
    <li
        >UW student? <strong
            ...
            quarter</strong
        >. Complete the steps above first, and then choose one of the these ways
