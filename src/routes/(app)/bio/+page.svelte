...
<p>
	Amy J. Ko is a Professor at the <External to="http://www.washington.edu">University of Washington</External> <External to="http://ischool.uw.edu/">Information School</External> and an Adjunct Professor at the <External to="http://cs.washington.edu">Paul G. Allen School of Computer Science and Engineering</External>.
	...
	Her later work studied interactions between developers and users, and techniques for web scale aggregation of user intent through help systems; she co-founded <External to="http://www.answerdash.com">AnswerDash</External> to commercialize these ideas.
	...
	{ mipAwardCount } receiving most influential paper awards.
	She is an ACM Senior Member, a member of ACM SIGCHI, SIGCSE, and SIGSOFT, and a member of the <External to="https://sigchi.org/awards/">SIGCHI Academy</External>, for her substantial contributions to the field of human-computer interaction.
	She received her Ph.D. at the <External to="http://www.hcii.cs.cmu.edu">Human-Computer Interaction Institute</External> at <External to="http://www.cmu.edu">Carnegie Mellon University</External> in 2008, and degrees in Computer Science and Psychology with Honors from <External to="http://www.oregonstate.edu">Oregon State University</External> in 2002.
</p>

<Linkable id="irreverent">Irreverent Bio</Linkable>

<p>
	Amy J. Ko is one of those strange, awkward, lucky people at the <External to="http://www.washington.edu">University of Washington</External> who gets paid to follow her curiosity and tell people what she finds.
	...
	She's grateful to <External to="http://www.cmu.edu">Carnegie Mellon University</External> and <External to="http://www.oregonstate.edu">Oregon State University</External> for being mostly safe spaces to bumble through the world's endless expanse of mysteries as a student, and to the many students and taxpayers that pay her to keep doing it as a professor.
</p>
...
<ul>
	<li><External to="http://www.cs.cmu.edu/~bam/">Brad Myers</External>, (Ph.D., University of Toronto), who was advised by...</li>
	<li><External to="http://ron.taglab.ca/">Ronald Baecker</External>, (Ph.D., MIT) and <External to="https://www.billbuxton.com">Bill Buxton</External> (unofficially), who was advised by...</li>
	<li><External to="https://www.nap.edu/read/4779/chapter/21#93">Edward L. Glaser</External> (A.B., Dartmouth College), who taught Ron at MIT, who had highly interdisciplinary interests, and who was blind.</li>
</ul>

<p>As an undergraduate, I was also advised by...</p>
<ul>
	<li><External to="http://web.engr.oregonstate.edu/~burnett/">Margaret Burnett</External> (Ph.D., University of Kansas), who was advised by...</li>
	<li><External to="https://www.mathgenealogy.org/id.php?id=82631">Allen Ambler</External> (Ph.D., University of Wisconsin-Madison).</li>
</ul>
...
<p>
	...
	At the same time, I joined <External to="http://web.engr.oregonstate.edu/~burnett/">Margaret Burnett</External>'s research group, and stayed for two years. 
	In my senior year, I focused on my honors thesis project, advised largely by <External to="http://www.docbob.ca/">Bob Uttl</External>. 
...
<p>
	...
	In 2013, I co-founded <External to="http://www.answerdash.com">AnswerDash</External> with Jake Wobbrock and Parmit Chilana. 
