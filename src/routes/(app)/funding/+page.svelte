...
<Block link="https://ischool.uw.edu" header="The Information School">
    ...
    my core intellectual community. The iSchool's resources come from tuition, fees,
    taxes from the Washington state government, and philanthropic giving.
</Block>
...
<Block link="https://nsf.gov" header="National Science Foundation">
    ...
    {/snippet}
    &mdash; The majority of my sponsored research is funded by the U.S. National Science
    Foundation, which is tax-funded. I write proposals, which are confidentially evaluated
    by my peers, and when my peers and NSF find my proposals to have compelling intellectual
    merit and potential for broader impact, I receive grants. I use these grants to
    support my summer salary, my doctoral students stipends, benefits, and tuition,
    my lab's research expenses, hourly undergraduate research assistants, and our
    travel. My doctoral students also write their own proposals, often winning NSF
    ...
    <a href={asset('/papers/Ko2009CAREER.pdf')}>awarded proposal</a>.
</Block>
<Block link="https://microsoft.com" header="Microsoft">
    ...
    Research and Microsoft's developer division, will give me unrestricted gifts to
    support my lab. These are no strings attached contributions, which I rely on for
    expenses that the iSchool and NSF will not support, such as buying out of teaching
    to free up research time and unplanned research expenses.
</Block>

<Block link="https://google.com" header="Google">
    {#snippet image()}
        <Image url={'/images/funding/google.jpg'} alt="The Google logo." />
    {/snippet}
...
<Block link="http://adobe.com" header="Adobe">
    {#snippet image()}
        <Image url={'/images/funding/adobe.jpg'} alt="The Adobe logo." />
    {/snippet}
