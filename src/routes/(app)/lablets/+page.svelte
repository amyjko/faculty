...
<p>
	...
	We provide <External to="https://docs.google.com/spreadsheets/d/1ziwgmDBdCNY1AbhlQti8hgabwhVhwvRpL8xPjknywnQ/edit#gid=1849819586">meeting templates</External> for many of the above activities to help you understand roles and expectations.
	However, you're always welcome to deviate from them, or suggest improvements to them, by writing Amy a DM in <External to="http://computinged-uw.slack.com">Slack</External>.
</p>
...
<p>
	You can see when the lablets (and main lab meeting) are scheduled by subscribing to our lab calendar (add <strong>codeandcognition@uw.edu</strong> if using UW G Suite, download this <External to="https://calendar.google.com/calendar/ical/codeandcognition%40uw.edu/public/basic.ics">ICS file</External> otherwise).
</p>

<Linkable id="1styear">Can I join as a 1st year student with no research experience?</Linkable>
...
<ul>
	...
	<li>Post in <External to="http://computinged-uw.slack.com">ComputingEd@UW Slack</External> #codeandcognitionlab</li>
	<li>
		Earn 1 credit by registering for <External to="https://ischool.uw.edu/programs/informatics/curriculum/experiential-learning/independent-study">INFO 499 Independent Study</External> with Amy. 
		To sign up, follow the <External to="https://ischool.uw.edu/programs/informatics/curriculum/experiential-learning/independent-study">instructions for registering for INFO 499</External>; your proposal only needs to mention that you'll be participating in a lablet and the required reflection.
	</li>
</ul>
...
<ol>
	<li>Review the <External to="https://docs.google.com/spreadsheets/d/1ziwgmDBdCNY1AbhlQti8hgabwhVhwvRpL8xPjknywnQ/edit#gid=0">active lablets</External>.</li>
	<li>Join the <External to="http://computinged-uw.slack.com">ComputingEd@UW Slack</External> (follow this link and use your UW address to create an account on the Slack).</li>
	...
	<li>Once you have access, add your name to the <External to="https://docs.google.com/spreadsheets/d/1ziwgmDBdCNY1AbhlQti8hgabwhVhwvRpL8xPjknywnQ/edit#gid=772195334">students</External> sheet.</li>
...
<ol>
	...
	<li>First check the <External to="https://docs.google.com/spreadsheets/d/1ziwgmDBdCNY1AbhlQti8hgabwhVhwvRpL8xPjknywnQ/edit#gid=0">active lablets</External> to ensure there isn't a suitable lablet to join already.</li>
	...
	<li>Ask your supervisor to create a room in the <External to="https://ohyay.co/s/codeandcognition">Code and Cognition Ohyay</External> and give you admin permissions to design it.</li>
...
<Linkable id="recommendation">Can I get a letter of recommendation for participating?</Linkable>
<p>
...
<ul>
	<li>
		If you <em>participated</em> in a lablet, but did not interact with Amy in a sustained way over a significant period of time, 
		she will write a <strong>templated</strong> letter that explains what lablets are, confirms that you participated in one, and include a personalized statement from your lablet supervisor. 
		This won't be a very helpful letter, since it will read as a slightly personalized form letter, 
		but it will at least indicate participation, interest, 
		and help you meet whatever unreasonable and oppressive requirements some employer or school has set about letters.</li>
	<li>
		If you <em>led</em> a lablet, Amy will meet with you, discuss your experiences and interests, and write a short letter. 
		This will be more valuable than the templated letter above.
	</li>
</ul>
...
<Linkable id="otherparticipation">Are there other ways I can participate in the lab other than lablets?</Linkable>
...
<ul>
	<li>
		We recruit undergraduates for full-time paid summer research positions each Winter through the <External to="https://dub.washington.edu/gettinginvolved.html#tab_prospective">DUB REU program</External>. 
