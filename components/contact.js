		...
		return (
			<div>
				...
				<Block 
					...
					header="Slack"
					content="I use Slack for all of my internal lab communications, and for many of my internal UW communication. I treat Slack like instant messaging, and after hours, like email. If you're at UW, join DUB Slack and DM me. I'm usually pretty responsive throughout the day."
				/>
				...
				<Block 
					...
					header="LinkedIn"
					content="I use LinkedIn as my primary contact manager. I usually only accept connections from people I've met IRL and have a professional relationship with (students, collaborators, professional colleagues). I do read my LinkedIn messages as part of my morning email routine."
				/>
