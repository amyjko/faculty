		...
		return (
			<div>
				...
				<div className="project row">
					...
					<div className="col-md-9">
						<div className='lead'><a href="https://www.youtube.com/watch?v=TjkzAls5fsI&t=84s">A Human View of Programming Languages</a> (2016). <small>This was an invited keynote at <a href="https://2016.splashcon.org/">SPLASH 2016</a>, in which I built upon Seymour Papert's arguments about computing culture and the need for embracing multiple views of what programming is. See <a href={this.props.app.getWebRoot() + "/slides/SPLASH2016Keynote.pdf"}>my slides</a> and <a href="https://www.youtube.com/watch?v=TjkzAls5fsI&t=84s">a recording of my talk</a>.</small></div>
					</div>
				</div>
