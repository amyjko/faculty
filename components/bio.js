	...
	render() {
		return (
			<div>
				...
				<p><img src={this.props.app.getWebRoot() + "/images/post-comingoutresponse.jpg"} className="pull-right img-float" />In Autumn 2019, I <a href="https://medium.com/bits-and-behavior/im-trans-call-me-amy-8a72a3951964" target="_blank">came out as a trans woman</a>, finally accepting my identity and having the confidence to share it with the world. My academic communities were <a href="https://medium.com/bits-and-behavior/what-coming-out-as-trans-should-look-like-395f31beeddb" target="_blank">incredibly supportive</a>, which gave me to confidence to be out and proud.</p>
