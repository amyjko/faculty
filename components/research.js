		...
		return (
			<div>
				...
				<p>
					...
					We share our work with three research communities: <Link to={"/cer"}><em>computing education</em></Link>, <em>human-computer interaction</em>, and <em>software engineering</em>.
